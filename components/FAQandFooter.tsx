...
function FAQandFooter() {
  ...
  return (
    <div className="bg-[#121212] text-white w-full overflow-hidden">
      {/* ===== FAQ SECTION ===== */}
      <section className="px-4 sm:px-6 md:px-10 pb-10 flex flex-col items-center text-center">
        ...
        <p className="text-gray-400 mt-3 mb-8 text-sm sm:text-base max-w-xl">
        ...
        <div className="w-full max-w-3xl space-y-4">
          {faqs.map((item, index) => (
            <div
              ...
              className={`rounded-xl border border-white/10 overflow-hidden cursor-pointer transition-all duration-300 ${
                open === index
                  ? "bg-gradient-to-r from-rose-600 to-red-600 shadow-lg"
                  : "bg-[#1a1a1a] hover:border-pink-400/30"
              }`}
            >
              ...
              {open === index && (
                <div className="px-3 sm:px-4 pb-4 text-gray-100 text-sm sm:text-base leading-relaxed">
                  {item.a}
                </div>
              )}
            </div>
      ...
      <section className="py-16 sm:py-20 flex flex-col items-center text-center border-t border-white/10 px-4 sm:px-6">
        ...
        <p className="text-gray-400 mb-10 sm:mb-12 text-sm sm:text-base max-w-md">
          Find quick answers or reach out to our support team.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl w-full">
          {/* Help Center */}
          <div className="bg-gradient-to-br from-black via-[#1a1a1a] to-slate-900 border border-white/10 p-5 sm:p-6 rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300">
            <div className="flex items-center justify-center mb-4">
              <HelpCircle className="text-gray-400 w-8 h-8 sm:w-10 sm:h-10" />
            </div>
            ...
            <button className="px-4 sm:px-5 py-2 rounded-lg bg-gradient-to-r from-rose-500 to-rose-800 text-gray-200 text-sm hover:opacity-90 transition">
              Browse Articles
            </button>
          </div>
          ...
          <div className="bg-gradient-to-br from-black via-[#1a1a1a] to-slate-900 border border-white/10 p-5 sm:p-6 rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300">
            <div className="flex items-center justify-center mb-4">
              <Mail className="text-gray-400 w-8 h-8 sm:w-10 sm:h-10" />
            </div>
            <h4 className="text-gray-200 text-lg mb-2">Contact Us</h4>
            <p className="text-gray-400 text-sm sm:text-base mb-4">
      ...
      {/* ===== FOOTER ===== */}
      <footer className="relative bg-[#0d0d0d] py-10 sm:py-12 px-4 sm:px-6 mt-10 border-t border-white/10 overflow-hidden">
        {/* Watermark */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10 sm:gap-14">
          ...
          <div className="flex-1 min-w-[200px]">
            <h2 className="text-2xl font-bold mb-2 bg-gradient-to-r from-rose-500 to-rose-800 bg-clip-text text-transparent">
              Zidiotask
            </h2>
            ...
            <div className="flex gap-4 justify-start">
              <Facebook className="w-5 h-5 text-gray-400 hover:text-pink-400 cursor-pointer transition" />
              <Twitter className="w-5 h-5 text-gray-400 hover:text-pink-400 cursor-pointer transition" />
              <Instagram className="w-5 h-5 text-gray-400 hover:text-pink-400 cursor-pointer transition" />
            </div>
          </div>

          {/* Right */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8 text-sm text-gray-400 w-full sm:w-auto">
            <div>
        ...
        <div className="relative z-10 text-center text-gray-500 text-xs sm:text-sm mt-8 sm:mt-10">
