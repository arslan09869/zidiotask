            ...
            <Card className="border-border/70 bg-card/20 w-full max-w-md shadow-[0_10px_26px_#e0e0e0a1] backdrop-blur-lg dark:shadow-none">
              <CardContent className="space-y-6 p-8">
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <Button className="w-full bg-[hsl(348.97deg_71.31%_52.16%)] hover:bg-[hsl(348.97deg_71.31%_45%)] transition-colors duration-300 text-gray-200">Continue</Button>
                </motion.div>
                ...
                >
                  <Button
                    variant="secondary"
                    className="bg-white text-primary hover:bg-primary-foreground/95 w-full shadow-[0_4px_16px_var(--border)] duration-300 dark:shadow-[0_4px_14px_var(--muted-foreground)]"
                  >
                    <svg
                      className="h-5 w-5"
                      viewBox="0 0 24 24"
                    ...
                    <span className="ml-2 text-[#dc2e4e] hover:text-[hsl(348.97deg_71.31%_45%)] transition-colors duration-300">Sign in with Google</span>
                  </Button>
                </motion.div>
